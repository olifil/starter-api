...
export class AuthHttpController {
  ...
  @ApiOperation({
    summary:
      "Vérifier l'adresse email avec le token reçu par email (inscription ou changement d'email)",
  })
  @ApiResponse({ status: 204, description: 'Email vérifié ou mis à jour avec succès' })
  @ApiResponse({ status: 400, description: 'Token invalide ou expiré' })
  @ApiResponse({ status: 409, description: 'Email déjà utilisé' })
